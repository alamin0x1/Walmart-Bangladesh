...
import com.developeralamin.web.databinding.ActivityBestbuyBinding;
...
public class BestbuyActivity extends AppCompatActivity {

    private ActivityBestbuyBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBestbuyBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        getSupportActionBar().hide();

        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("bestbuy");
